...
#===================================================================
current_longitude = 13.210056
current_latitude = 55.711054
#===================================================================
...
#===================================================================
SERVER="http://192.168.1.13:5001/drone"
...
def main():
    ...
    #===================================================================
    with open("Drone_coords.txt") as f:
        text = f.read().strip("()").split(", ")
        current_longitude = float(text[0])
        current_latitude = float(text[1])
    #===================================================================
